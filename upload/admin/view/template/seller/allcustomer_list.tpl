      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-approved"><?php echo $entry_seller_approved; ?></label>
          ...
          <form action="<?php echo $addtoseller; ?>" method="post" enctype="multipart/form-data" id="form-customer">
          <div class="container-fluid">
			        <div class="form-group">
                       ...
                       <button type="button" data-toggle="tooltip" title="<?php echo $button_addtoseller; ?>" class="btn btn-success" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;"><i class="fa fa-plus"></i></button>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['seller_group']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=seller/seller/add&token=<?php echo $token; ?>';
