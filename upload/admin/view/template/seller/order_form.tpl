      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            <li class="disabled active"><a href="#tab-seller" data-toggle="tab">1. <?php echo $tab_seller; ?></a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-seller">
              ...
              <div class="text-right">
                <button type="button" id="button-seller" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i> <?php echo $button_continue; ?></button>
              </div>
            </div>
            <div class="tab-pane" id="tab-cart">
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('a[href=\'#tab-seller\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/cart/products&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
...
$('input[name=\'seller\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			...
			success: function(json) {
				json.unshift({
					seller_id: '0',
					seller_group_id: '<?php echo $seller_group_id; ?>',						
				...
				response($.map(json, function(item) {
					return {
						category: item['seller_group'],
						label: item['name'],
						value: item['seller_id'],
						seller_group_id: item['seller_group_id'],						
	...
	'select': function(item) {
		...
		$('#tab-seller input[type=\'text\'], #tab-seller input[type=\'text\'], #tab-seller textarea').not('#tab-seller input[name=\'seller\'], #tab-seller input[name=\'seller_id\']').val('');
		$('#tab-seller select option').removeAttr('selected');
		$('#tab-seller input[type=\'checkbox\'], #tab-seller input[type=\'radio\']').removeAttr('checked');
		
		$('#tab-seller input[name=\'seller\']').val(item['label']);
		$('#tab-seller input[name=\'seller_id\']').val(item['value']);
		$('#tab-seller select[name=\'seller_group_id\']').val(item['seller_group_id']);
		$('#tab-seller input[name=\'firstname\']').val(item['firstname']);
		$('#tab-seller input[name=\'lastname\']').val(item['lastname']);
		$('#tab-seller input[name=\'email\']').val(item['email']);
		$('#tab-seller input[name=\'telephone\']').val(item['telephone']);
		$('#tab-seller input[name=\'fax\']').val(item['fax']);		
				
		for (i in item.custom_field) {
			$('#tab-seller select[name=\'custom_field[' + i + ']\']').val(item.custom_field[i]);
			$('#tab-seller textarea[name=\'custom_field[' + i + ']\']').val(item.custom_field[i]);
			$('#tab-seller input[name^=\'custom_field[' + i + ']\'][type=\'text\']').val(item.custom_field[i]);
			$('#tab-seller input[name^=\'custom_field[' + i + ']\'][type=\'hidden\']').val(item.custom_field[i]);
			$('#tab-seller input[name^=\'custom_field[' + i + ']\'][type=\'radio\'][value=\'' + item.custom_field[i] + '\']').prop('checked', true);	
			
			if (item.custom_field[i] instanceof Array) {
				for (j = 0; j < item.custom_field[i].length; j++) {
					$('#tab-seller input[name^=\'custom_field[' + i + ']\'][type=\'checkbox\'][value=\'' + item.custom_field[i][j] + '\']').prop('checked', true);
				}
			}
		}
...
$('select[name=\'seller_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=seller/sale/customfield&token=<?php echo $token; ?>&seller_group_id=' + this.value,
		dataType: 'json',	
		success: function(json) {
			$('.custom-field').hide();
...
$('#button-seller').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/seller&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		data: $('#tab-seller input[type=\'text\'], #tab-seller input[type=\'hidden\'], #tab-seller input[type=\'radio\']:checked, #tab-seller input[type=\'checkbox\']:checked, #tab-seller select, #tab-seller textarea'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-seller').button('loading');
		},
		complete: function() {
			 $('#button-seller').button('reset');
		},
		success: function(json) {
			$('.alert, .text-danger').remove();
...
$('#button-product-add').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/cart/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher-add').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/voucher/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/cart/remove&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/address&token=<?php echo $token; ?>&address_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#tab-payment select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=seller/order/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/payment/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/payment/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/shipping/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				$.ajax({
					url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/shipping/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/shipping/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/payment/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/coupon&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/voucher&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/reward&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (order_id == 0) {
		var url = 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/order/add&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = 'index.php?route=seller/order/api&token=<?php echo $token; ?>&api=api/order/edit&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + order_id;
	}
