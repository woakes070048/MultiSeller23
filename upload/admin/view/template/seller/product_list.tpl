            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'c.seller') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
<a href="<?php echo $product['seller_url']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-link"><?php echo $product['seller']; ?></a>
                    </td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=seller/product&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=seller/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_seller\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=seller/product/autocomplete&token=<?php echo $token; ?>&filter_seller=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=seller/product/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
